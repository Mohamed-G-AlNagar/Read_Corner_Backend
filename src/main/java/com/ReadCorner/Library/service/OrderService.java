...
//    @Transactional
//    public void decreaseBooksStock(Order order) {
//        String updateQuery = "UPDATE Book b SET b.stock = b.stock - :quantity WHERE b.id = :bookId";
//
//        try {
//            for (OrderItem item : order.getOrderItems()) {
//                int updatedRows = entityManager.createQuery(updateQuery)
//                        .setParameter("quantity", item.getQuantity())
//                        .setParameter("bookId", item.getBook().getId())
//                        .executeUpdate();
//
//                if (updatedRows != 1) {
//                    throw new RuntimeException("Failed to update stock for book with ID " + item.getBook().getId());
//                }
//            }
//        } catch (PersistenceException e) {
//            throw new RuntimeException("Error occurred while updating book stock: " + e.getMessage(), e);
//        }
//    }
//
//    @Transactional
//    public void increaseBooksStock(Order order) {
//        String updateQuery = "UPDATE Book b SET b.stock = b.stock + :quantity WHERE b.id = :bookId";
//
//        try {
//            for (OrderItem item : order.getOrderItems()) {
