...
//    @Override
//    public void run(String... args) {
//        // Check if the app_init_flag table exists
//        boolean tableExists = jdbcTemplate.queryForObject(
//                "SELECT COUNT(*) FROM information_schema.tables WHERE table_name = 'app_init_flag'",
//                Integer.class
//        ) > 0;
//
//        if (!tableExists) {
//            // Create the app_init_flag table if it doesn't exist
//            jdbcTemplate.execute(
//                    "CREATE TABLE app_init_flag (id INT PRIMARY KEY, initialized BOOLEAN NOT NULL)"
//            );
//            jdbcTemplate.update(
//                    "INSERT INTO app_init_flag (id, initialized) VALUES (1, false)"
//            );
